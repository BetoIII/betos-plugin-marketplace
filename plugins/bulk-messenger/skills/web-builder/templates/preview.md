...
Read `global-styles.md` and `component-reference.md` from the templates folder to guide your styling. All component styles (tables, phone preview, buttons, etc.) are defined there. Inline all CSS in the output HTML file — do not link to external stylesheets.
